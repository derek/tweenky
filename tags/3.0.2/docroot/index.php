		...
		<div align="center" style="width:100%; margin:60px 0px 100px 0px;">
			<div id="main-box" style="width:400px; background-color:#ffffff; padding:10px 50px 20px 50px;" class="rounded">
				...
				<div style="border:solid 0px #333333; padding:0px;">
					<? if (detect_ie()) { ?>
					<div align="left">
						Party foul!! It looks like you are using Internet Explorer. We are still in an early beta phase and IE7 support is coming soon.
					</div><br>
					<div>
						In the meantime, you should<br>
						<a href="http://www.getfirefox.com/">go download Firefox</a>!
					</div><? } else {
												if (isset($_GET['auto'])) { ?>
					<p style="color:red;">
					...
					<form method="get" id="login-form" onsubmit="return login()" name="login-form">
						<br>
						<div align="center">
			...
			<div id="faq-box" style="width:400px; background-color:#ffffff; padding:10px 50px 20px 50px;" class="rounded" align="left">
				...
				<p>
					A web-based micro-blogging ("tweet") client that currently supports Twitter and Identi.ca/Laconi.ca.
				</p>
				<p>
					You can read more about it on <a href="http://www.techcrunch.com/2008/07/24/tweenky-brings-gmails-good-looks-to-twitter/">TechCrunch</a>
				</p>
				<h2>
				...
				<ul>
					<li>Integration with search.twitter.com (formerly Summize) to allow you to find &amp; track content as it flows through the "Twitterverse".
					</li>
					<li>Ajax powered auto-tweet-updating goodness so you never have to reload. You can just sit back... and wach the tweets roll through.
					</li>
					<li>A list of hot topics that fills you in on the latest buzz in the "Twitterverse".
					</li>
					<li>And more!
					</li>
				</ul>
				...
				<p>
					<a href="http://www.twitter.com/derek">This guy</a>
				</p>
				<h2>
					Anything else you want to tell me?
				</h2>
				<p>
					Nope, I'm done. But is there anything you'd like to <a href="mailto:feedback@tweenky.com">tell me</a>?
				</p>
			</div>
